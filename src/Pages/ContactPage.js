        ...
        <div>
            ...
            <div className="ContactPage">
                ...
                <div className="contact-sect">
                    <ContactItem icon={phone} text1={'+998(99)-008-27-35'} text2={'+998(33)-027-27-35'} title={'Phone'}/>
                    <ContactItem icon={email} text1={'nodirbek_0308@mail.ru'} text2={'gektor4508@gmail.com'} title={'Email'}/>
                    <ContactItem icon={location} text1={'3/12 A.Qodiriy st., Zangiota'} text2={'Tashkent, Uzbekistan'} title={'Address'}/>
                </div>
            </div>
        </div>
    )
